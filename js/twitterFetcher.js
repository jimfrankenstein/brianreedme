...
(function(root, factory) {
  ...
  var twitterFetcher = {
    ...
    callback: function(data) {
      ...
      function write_tweet_post_time( post_time ) {
        try {
          return post_time.replace( "Posted", "Twittered" );
        } catch( e ) {
          return post_time;
        }
      }
      ...
      while(n < x) {
        ...
        if (parseLinks) {
          ...
          if (printTime) {
            op += '<p class="timePosted">' + write_tweet_post_time( times[n].getAttribute('aria-label') ) + '</p>';
          }
        } else {
          if (tweets[n].innerText) {
            if (printUser) {
            ...
            if (printTime) {
              op += '<p class="timePosted">' + write_tweet_post_time( times[n].innerText ) + '</p>';
            }
            ...
            if (printTime) {
              op += '<p class="timePosted">' + write_tweet_post_time( times[n].textContent ) + '</p>';
            }
          }
        }
